...
export type TitrationTab = "experiment" | "theory" | "results";

const TABS: { key: TitrationTab; label: string; icon: keyof typeof Ionicons.glyphMap }[] = [
...
type TitrationTabHeaderProps = {
  subjectLabel: string;
  activeTab: TitrationTab;
  bookmarked: boolean;
  accentColor: string;
  accentTint: string;
  onBack: () => void;
  onChangeTab: (tab: TitrationTab) => void;
  onToggleBookmark: () => void;
  onShare: () => void;
};

export function TitrationTabHeader({
  subjectLabel,
  activeTab,
  bookmarked,
  accentColor,
    ...
    <View>
      <View className="flex-row items-center justify-between">
        ...
        <View className="items-center">
          <Text className="text-[19px] font-poppins-bold text-text-primary">Acid-Base Titration</Text>
