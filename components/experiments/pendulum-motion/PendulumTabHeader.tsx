...
export type PendulumTab = "experiment" | "theory" | "results";

const TABS: { key: PendulumTab; label: string; icon: keyof typeof Ionicons.glyphMap }[] = [
...
type PendulumTabHeaderProps = {
  topicLabel: string;
  activeTab: PendulumTab;
  bookmarked: boolean;
  onBack: () => void;
  onChangeTab: (tab: PendulumTab) => void;
  onToggleBookmark: () => void;
  onShare: () => void;
};

export function PendulumTabHeader({
  topicLabel,
  activeTab,
  bookmarked,
  onBack,
    ...
    <View>
      <View className="flex-row items-center justify-between">
        ...
        <View className="items-center">
          <Text className="text-[19px] font-poppins-bold text-text-primary">Pendulum Motion</Text>
          <View
