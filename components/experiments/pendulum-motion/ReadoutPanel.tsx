...
export function ReadoutPanel({ period, frequency, velocity }: ReadoutPanelProps) {
  const readouts: Readout[] = [
    { icon: "time-outline", label: "Period (T)", value: `${period.toFixed(2)} s` },
    { icon: "pulse-outline", label: "Frequency (f)", value: `${frequency.toFixed(2)} Hz` },
